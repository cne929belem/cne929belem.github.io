...
<div class="info-pagina">
        ...
        <section class="info-bloco">
            ...
            <div class="info-block">
                ...
                <p style="line-height: 1.6; margin-bottom: 15px;"><strong>O Escutismo Marítimo</strong> aumenta o interesse pelo escutismo pois, para além das atividades típicas, são efetuadas atividades de cariz náutico. Aprende-se a velejar e a desenvolver capacidades com métodos e embarcações adequadas, tendo sempre em conta a capacidade de cada elemento para fazê-los crescer de forma saudável e justa.</p>
                
                <p style="line-height: 1.6; margin-bottom: 0;">Nos Escuteiros Marítimos os escalões etários dividem-se em: <strong>Lobitos</strong>, <strong>Moços</strong>, <strong>Marinheiros</strong> e <strong>Companheiros</strong>, sempre acompanhados por um Dirigente que os orienta na sua vida escutista.</p>
            </div>
        </section>
        ...
        <section class="info-bloco contactos">
            ...
            <div class="info-block azul-claro">
                <ul style="list-style: none; padding: 0; margin: 0; line-height: 2;">
                    ...
                    <li>🏕️ <strong>Paiol do Agrupamento:</strong> <a href="mailto:paiol.929@escutismo.pt" style="color: var(--azul-claro); text-decoration: none; font-weight: bold;">paiol.929@escutismo.pt</a></li>
