---
layout: default
title: Diário de Bordo | II - Flotilha
...
seccao_cor: '#28a745'
---
<section class="hero-generico hero-seccao hero-flotilha" id="hero"><div class="pagina-cabecalho"><span class="icone-hero-caixa" aria-hidden="true"><img class="icone-hero-seccao" src="{{ '/assets/img/seccoes/2_mocos.png' | relative_url }}" alt=""></span><h1>Diário de Bordo</h1><p>As memórias das navegações da Flotilha.</p></div></section>
...
<div class="comunidade-pagina">
	...
	<section class="card">
		...
		<p style="line-height: 1.6; margin-bottom: 30px;">O arquivo vivo da nossa Flotilha, onde reunimos memórias, relatórios e imagens das atividades.</p>
