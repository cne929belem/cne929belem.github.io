...
seccao_cor: '#0056b3'
---
<section class="hero-generico hero-seccao hero-frota" id="hero"><div class="pagina-cabecalho"><span class="icone-hero-caixa" aria-hidden="true"><img class="icone-hero-seccao" src="{{ '/assets/img/seccoes/3_marinheiros.png' | relative_url }}" alt=""></span><h1>Diário de Bordo</h1><p>As memórias das navegações da Frota.</p></div></section>
