...
<div class="content-wrapper" style="justify-content: center; align-items: center; flex-direction: column;">
    <section class="card" style="max-width: 800px; width: 100%;">
        ...
        <div style="text-align: left; margin: 20px 0;">
            <img src="{{ '/assets/img/26acagrup.jpeg' | relative_url }}" alt="Fotografia do Acampamento de Agrupamento 2026 - Ilha dos Cavalos" style="width: 100%; height: auto; border-radius: 8px; margin-bottom: 15px;">
